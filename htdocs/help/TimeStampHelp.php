...
<body>
  <div id="container">
    ...
    <h1>Entry time stamps</h1>This feature can be toggled and
    configured under <b>Options -&gt; Preferences -&gt;
    General</b>. 

    <p>JabRef can automatically set a field to contain the date an
    entry was added to the database.</p>

    <h2>Formatting</h2>The formatting of the time stamp is
    determined by a string containing designator words that
    indicate the position of the various parts of the date. 
