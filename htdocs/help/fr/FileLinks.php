...
<body>
  <div id="container">
    ...
    <h1>Liens de fichier dans JabRef</h1>JabRef vous permet de lier
    ...
    ouvert rapidement depuis JabRef. 
    ...
    <h2>Configurer les types de fichiers externes</h2>Pour chaque
    ...
    entr&eacute;e</h2>Si le champ "fichier" est inclus dans les
    ...
    <h2>Ouvrir les fichiers externes</h2>Il y a plusieurs
