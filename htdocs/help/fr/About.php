...
<body>
  <div id="container">
    ...
    <center>
        ...
        <h2>D&eacute;veloppeurs&nbsp;:</h2>Morten O. Alver, Nizar
        N. Batada, Michel Baylac, Kolja Brix,
        Fr&eacute;d&eacute;ric Darboux, Guillaume Gardey, Cyrille
        d'Haese, S M Mahbub Murshed, Raik Nagel, Christopher
        ...
        <h2>Contributions de&nbsp;:</h2>Michael Beckmann, Oliver
        Beckmann, Fabrice Dessaint, Nathan Dunn, Brian Van Essen,
        Alexis Gallagher, David Gleich, Sascha Hunold, Bernd
        ...
        <h2>Remerciements &agrave;&nbsp;:</h2>Samin Muhammad
        Ridwanul Karim, Stefan Robert 

        <h2>Logiciels tiers utilis&eacute;s&nbsp;:</h2>JabRef
