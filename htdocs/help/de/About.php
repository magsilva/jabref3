...
<body>
  <div id="container">
    ...
    <center>
        <h1>JabRef Version @version@</h1>(c) 2007
        ...
        <h2>Entwickler:</h2>Morten O. Alver, Nizar N. Batada,
        Michel Baylac, Kolja Brix, Fr&eacute;d&eacute;ric Darboux,
        Guillaume Gardey, Cyrille d'Haese, Raik Nagel, Christopher
        Oezbek, Ellen Reitmayr, Gert Renckens, Andreas Rudert,
        Michael Spiegel, Ulrik Stervbo, Dominik Wa&szlig;enhoven,
        Joerg K. Wegner, Michael Wrighton, Egon Willighagen,
        J&ouml;rg Zieren

        <h2>Beitr&auml;ge von:</h2>Michael Beckmann, Oliver
        B&ouml;ckmann, Fabrice Dessaint, Nathan Dunn, Brian Van
        Essen, Alexis Gallagher, David Gleich, Sascha Hunold, Bernd
        Kalbfuss, Martin K&auml;hmer, Ervin Kolenovic, Krzysztof A.
        Ko&#347;ciuszkiewicz, Christian Kopf, Jeffrey Kuhn, Alex
        Montgomery, S. M. Mahbub Murshed, Ambrogio Oliva, Stephan
        Rave, John Relph, Hannes Restel, Moritz Ringler, Andreas
        Rudert, Mark Schenk, Rudolf Seemann, Toralf Senger, Manuel
        Siebeneicher, Mike Smoot, Ulrich St&auml;rk, Martin Stolle,
        David Weitzman, Seb Wills, John Zedlewski

        <h2>Dank an:</h2>Samin Muhammad Ridwanul Karim, Stefan
        Robert

        <h2>Benutzte Fremdsoftware:</h2>JabRef benutzt JGoodies
        ...
        f&uuml;r n&auml;here Einzelheiten dieser Lizenz).
