...
public class EntryFromFileCreatorManagerTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		existingFile = new File("test/net/sf/jabref/imports/unlinkedFilesTestFolder/pdfInDatabase.pdf");
		notExistingFile = new File("test/net/sf/jabref/imports/unlinkedFilesTestFolder/null.pdf");
		
		pdfNotInDatabase = new File("test/net/sf/jabref/imports/unlinkedFilesTestFolder/pdfNotInDatabase.pdf");

		manager1 = new EntryFromFileCreatorManager();
		ParserResult result = BibtexParser.parse(new FileReader("test/net/sf/jabref/util/unlinkedFilesTestBib.bib"));
