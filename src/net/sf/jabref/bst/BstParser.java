// $ANTLR 3.5.2 Bst.g 2014-05-21 01:24:46
// Generated by ANTLR
...
public class BstParser extends Parser {
	...
	@Override public String getGrammarFileName() { return "Bst.g"; }
	...
	// $ANTLR start "program"
	// Bst.g:22:1: program : ( commands )+ -> ^( COMMANDS ( commands )+ ) ;
	public final BstParser.program_return program() throws RecognitionException {
		...
		try {
			// Bst.g:22:9: ( ( commands )+ -> ^( COMMANDS ( commands )+ ) )
			// Bst.g:22:11: ( commands )+
			{
			// Bst.g:22:11: ( commands )+
			int cnt1=0;
			loop1:
	...
	// Bst.g:24:1: commands : ( STRINGS ^ idList | INTEGERS ^ idList | FUNCTION ^ id stack | MACRO ^ id '{' ! STRING '}' !| READ ^| EXECUTE ^ '{' ! function '}' !| ITERATE ^ '{' ! function '}' !| REVERSE ^ '{' ! function '}' !| ENTRY ^ idList0 idList0 idList0 | SORT ^);
	public final BstParser.commands_return commands() throws RecognitionException {
		...
		try {
			// Bst.g:25:2: ( STRINGS ^ idList | INTEGERS ^ idList | FUNCTION ^ id stack | MACRO ^ id '{' ! STRING '}' !| READ ^| EXECUTE ^ '{' ! function '}' !| ITERATE ^ '{' ! function '}' !| REVERSE ^ '{' ! function '}' !| ENTRY ^ idList0 idList0 idList0 | SORT ^)
			int alt2=10;
			switch ( input.LA(1) ) {
			case STRINGS:
				{
			...
			switch (alt2) {
				...
				case 8 :
					...
					break;
				case 9 :
					// Bst.g:33:4: ENTRY ^ idList0 idList0 idList0
					{
					root_0 = (Object)adaptor.nil();
	...
	// Bst.g:36:1: identifier : IDENTIFIER ;
	public final BstParser.identifier_return identifier() throws RecognitionException {
		...
		try {
			// Bst.g:37:2: ( IDENTIFIER )
			// Bst.g:37:4: IDENTIFIER
			{
			root_0 = (Object)adaptor.nil();
	...
	public final BstParser.id_return id() throws RecognitionException {
		...
		try {
			// Bst.g:40:2: ( '{' ! identifier '}' !)
			// Bst.g:40:4: '{' ! identifier '}' !
			{
			root_0 = (Object)adaptor.nil();
	...
	// $ANTLR start "idList"
	// Bst.g:42:1: idList : '{' ( identifier )+ '}' -> ^( IDLIST ( identifier )+ ) ;
	...
	// $ANTLR start "idList0"
	// Bst.g:45:1: idList0 : '{' ( identifier )* '}' -> ^( IDLIST ( identifier )* ) ;
	public final BstParser.idList0_return idList0() throws RecognitionException {
		...
		try {
			...
			{
				// Bst.g:46:27: ^( IDLIST ( identifier )* )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(IDLIST, "IDLIST"), root_1);
				// Bst.g:46:36: ( identifier )*
				while ( stream_identifier.hasNext() ) {
					adaptor.addChild(root_1, stream_identifier.nextTree());
				}
				stream_identifier.reset();
	...
	// Bst.g:48:1: function : ( '<' | '>' | '=' | '+' | '-' | ':=' | '*' | identifier );
	...
	// $ANTLR start "stack"
	// Bst.g:51:1: stack : '{' ( stackitem )+ '}' -> ^( STACK ( stackitem )+ ) ;
	...
	// Bst.g:54:1: stackitem : ( function | STRING | INTEGER | QUOTED | stack );
	public final BstParser.stackitem_return stackitem() throws RecognitionException {
		...
		try {
			// Bst.g:55:2: ( function | STRING | INTEGER | QUOTED | stack )
			int alt7=5;
			switch ( input.LA(1) ) {
			case IDENTIFIER:
			case 25:
